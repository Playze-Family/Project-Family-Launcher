...
ipcRenderer.on('update-status', (event, title, desc) => {
    document.getElementById('loadStatusTitle').innerText = title
    if(desc) document.getElementById('loadStatusDesc').innerText = desc
})
